...
We can evaluate which density-dependent functions has the best projection compared to the observed community projection. The population projections are not great, which I am working on to understand why. (original code PopProjection.R and PopProjection_toolbox.R)
