...
save(PostFecunditydistribution , 
     file = "results/NaturalData_PostFecunditydistribution.csv.gz")
...
Nat_PostFecundityGraph <- ggplot(PostFecunditydistribution) +
  ...
  #                            "blue","red"))
ggsave("figures/Nat_PostFecundityGraph.pdf",
       plot = Nat_PostFecundityGraph
)
...
alpha_function == "function_4"

Nat_alphas_param <-     df_alpha_n
